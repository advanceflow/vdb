...
def load_dataset(train_dataset, img_dir, img_mat_url=default_img_mat_url, tag_mat_url=default_tag_mat_url, label_mat_url=default_label_mat_url, batch_size=128, train_num=10000, query_num=2000, seed=default_seed, **kwargs):
...
def get_single_datasets(img_dir, img_mat_url=default_img_mat_url, tag_mat_url=default_tag_mat_url, label_mat_url=default_label_mat_url, batch_size=128, query_num=2100, train_num=10500, seed=default_seed, **kwargs):
    print("load data set single Nus Wide")
    return load_dataset(CrossModalSingleTrain, img_dir, img_mat_url, tag_mat_url, label_mat_url, batch_size=batch_size, train_num=train_num, query_num=query_num, seed=seed, **kwargs)


def get_pairwise_datasets(img_dir, img_mat_url=default_img_mat_url, tag_mat_url=default_tag_mat_url, label_mat_url=default_label_mat_url, batch_size=128, query_num=2100, train_num=10500, seed=default_seed, **kwargs):
    print("load data set pairwise Nus Wide")
    return load_dataset(CrossModalPairwiseTrain, img_dir, img_mat_url, tag_mat_url, label_mat_url, batch_size=batch_size, train_num=train_num, query_num=query_num, seed=seed, **kwargs)


def get_triplet_datasets(img_dir, img_mat_url=default_img_mat_url, tag_mat_url=default_tag_mat_url, label_mat_url=default_label_mat_url, batch_size=128, query_num=2100, train_num=10500, seed=default_seed, **kwargs):
    print("load data set triplet Nus Wide")
    return load_dataset(CrossModalTripletTrain, img_dir, img_mat_url, tag_mat_url, label_mat_url, batch_size=batch_size, train_num=train_num, query_num=query_num, seed=seed, **kwargs)


def get_quadruplet_datasets(img_dir, img_mat_url=default_img_mat_url, tag_mat_url=default_tag_mat_url, label_mat_url=default_label_mat_url, batch_size=128, query_num=2100, train_num=10500, seed=default_seed, **kwargs):
    print("load data set quadruplet Nus Wide")
    return load_dataset(CrossModalQuadrupletTrain, img_dir, img_mat_url, tag_mat_url, label_mat_url, batch_size=batch_size, train_num=train_num, query_num=query_num, seed=seed, **kwargs)
